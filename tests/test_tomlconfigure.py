...
class Test_ShareObject(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def setUp(self):
        self.share_object = Test_ShareObject.share_object
    ...
    def test_instance(self):
        ...
        self.assertIsInstance(self.share_object.ipc, CircularBuffer)
...
class Test_TomlConfigure(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        from FlexiDNS.dnstoml import configs, share_objects
        cls.configs = configs
        cls.share_object = share_objects
